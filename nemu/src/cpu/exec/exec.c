...
opcode_entry opcode_table [512] = {
  ...
  /* 0x30 */	IDEXW(G2E,xor,0), IDEXW(G2E,xor,0), IDEXW(G2E,xor,0),IDEXW(G2E,xor,0),
  /* 0x34 */	IDEXW(I2a,xor,0), IDEXW(I2r,xor,0), EMPTY, EMPTY,
  ...
  /* 0xe4 */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(in_I2a,in,1), IDEXW(in_I2a,in,0),IDEXW(out_a2I,out,1), IDEXW(out_a2I,out,0),
  /* 0xe8 */	IDEXW(I, call,0), IDEXW(J,jmp,0), EMPTY,IDEXW(J,jmp,1),
  /* 0xec */	EMPTY, EMPTY, EMPTY, EMPTY,//IDEXW(in_dx2a,in,1), IDEXW(in_dx2a,in,0),IDEXW(out_a2dx,out,1), IDEXW(out_a2dx,out,0),
  ...
  /* 0x80 */	IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0),
  /* 0x84 */	IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0),
  /* 0x88 */	IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0),
  /* 0x8c */	IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0), IDEXW(J,jcc,0),
